...
import type { BrowserMBoxEmailParsedType } from '@fxbar/browser-mbox'

function PreviewContent({
  data,
}: {
  readonly data?: BrowserMBoxEmailParsedType | null
}) {
...
function PreviewContentAddress({
  ...
  readonly data?: BrowserMBoxEmailParsedType['from'][]
}) {
...
function PreviewContentAttachment<
  T extends BrowserMBoxEmailParsedType['attachments'][number],
